...
const CreateEvent = () => {
  ...
  useEffect(() => {
    ...
    const fetchCategories = async () => {
      try {
        ...
        setCategoriesData(data.categories); // Giả sử dữ liệu trả về có key 'categories'
      } catch (error) {
  ...
  return (
    <div className="w-[90%] 800px:w-[50%] bg-white  shadow h-[80vh] rounded-[4px] p-3 overflow-y-scroll">
      <h5 className="text-[30px] font-Poppins text-center">Thêm mới sự kiện</h5>
      {/* create event form */}
      <form onSubmit={handleSubmit}>
        ...
        <div>
          ...
          <input
            ...
            placeholder="Nhập giá sản phẩm đã chiết khấu..."
          />
        </div>
        <br />
        <div>
          ...
          <input
            ...
            placeholder="Nhập số lượng kho của sự kiện..."
          />
        </div>
        <br />
        <div>
